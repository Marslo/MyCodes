...
#     Version: 0.0.1
#  LastChange: 2014-05-16 10:29:16
#     History:
#              0.0.1 | Marslo | init
# =============================================================================
...
class IsValidArgus:
  def __init__(self):
    ...
    self.rel = {'fizz': 3, 'buzz': 5, 'whizz': 7}

    self.__info_getargs = 'Please input three Positive Integer divided by comma (default is 3,5,7). [Enter]:\n'
  ...
  def analysisNoptionArgus(self):
    for i in self.argulist:
      if self.argusValidity(i):
        self.rel[self.passwd[int(self.argulist.index(i))].lower()] = i
